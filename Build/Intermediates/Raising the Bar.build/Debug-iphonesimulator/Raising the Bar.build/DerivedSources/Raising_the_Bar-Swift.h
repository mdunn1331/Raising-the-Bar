...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Raising_the_Bar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Raising_the_Bar11AppDelegate")
...
SWIFT_CLASS("_TtC15Raising_the_Bar13SceneDelegate")
